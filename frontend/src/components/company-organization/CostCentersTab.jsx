...
export function CostCentersTab({ triggerToast, onSwitchTab }) {
  ...
  }, [filteredCostCenters, currentPage, pageSize]);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xs">
        ...
        <div className="px-4 py-3 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          <div>
            Showing {(currentPage - 1) * pageSize + 1} to {Math.min(currentPage * pageSize, filteredCostCenters.length)} of {filteredCostCenters.length} records
          </div>
