    ...
    <div className="space-y-6 select-none">
      ...
      <div className="border-b border-slate-200 pb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Discovery Settings</h1>
        ...
        {/* Top Navigation / Configuration Tabs */}
        <div className="flex items-center gap-1 mt-4 overflow-x-auto pb-1 text-xs font-semibold border-b border-slate-100">
          {[
      ...
      {/* VIEW 1: Main 6-Card Dashboard View (Visible when profiles, matching, global or all are selected) */}
      {(activeTab === 'profiles' || activeTab === 'matching' || activeTab === 'global') && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Discovery Profiles</h2>
                      ...
                      return (
                        <tr
                          ...
                          className={`cursor-pointer transition-colors ${
                            isSelected ? 'bg-blue-50/70 border-l-4 border-l-blue-600 font-medium' : 'hover:bg-slate-50'
                          }`}
                        >
                          <td className="py-2.5 px-3 font-semibold text-slate-900">{p.profileName}</td>
                          <td className="py-2.5 px-3 text-slate-600">{p.discoveryType}</td>
                          <td className="py-2.5 px-3 font-mono text-[11px] text-slate-600">{p.targetScope}</td>
              ...
              <div className="flex items-center justify-between pt-2 text-slate-500 text-[11px] border-t border-slate-100">
                <span>Showing 1 to {profiles.length} of {profiles.length} profiles</span>
                <div className="flex items-center gap-1">
                  <button className="px-2 py-0.5 border border-slate-200 rounded text-slate-400 cursor-not-allowed">&lt;</button>
            ...
            <div className="lg:col-span-5 bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Profile Configuration</h2>
                  <p className="text-[11px] text-slate-500">Configure settings for the selected discovery profile</p>
                </div>
                <select
                  value={selectedProfileId}
                  onChange={(e) => setSelectedProfileId(e.target.value)}
                  className="px-2 py-1 text-xs border border-slate-200 rounded-lg bg-slate-50 font-semibold text-slate-700"
                >
                  {profiles.map((p) => (
              ...
              <form onSubmit={handleSaveProfile} className="space-y-3 text-xs">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs bg-white"
                  >
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1.5">Scan Methods</label>
                  <div className="grid grid-cols-4 gap-2">
                    {['SNMP', 'WMI/WinRM', 'SSH', 'Ping Sweep'].map((method) => {
                      const isChecked = (profileForm.scanMethods || []).includes(method);
                      return (
                        <label key={method} className="flex items-center gap-1.5 text-[11px] text-slate-700 cursor-pointer">
                          <input
                            type="checkbox"
                            checked={isChecked}
                            onChange={(e) => {
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block font-semibold text-slate-700 mb-1">Scan Timeout (seconds)</label>
                    <input
                      type="number"
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Device Types</label>
                  <select
                ...
                <div className="flex items-center gap-2 pt-1">
                  <input
                    ...
                    className="rounded border-slate-300 text-blue-600 focus:ring-blue-500 w-3.5 h-3.5"
                  />
                  <label htmlFor="enableInv" className="text-xs text-slate-700 cursor-pointer font-medium">
                ...
                <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100">
                  <button
                    ...
                    className="px-3.5 py-1.5 text-xs font-semibold text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors"
                  >
                    Cancel
                  </button>
                  <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-6 bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Credential Vault</h2>
                  <p className="text-[11px] text-slate-500">
                ...
                <table className="w-full text-left text-xs text-slate-700">
                  <thead className="bg-slate-50 text-slate-600 font-semibold border-b border-slate-200 uppercase tracking-wider">
                    <tr>
                      ...
                      <th className="py-2 px-3">Used In Profiles</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {credentials.map((c) => (
                      <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="py-2.5 px-3 text-slate-600">{c.type}</td>
            ...
            <div className="lg:col-span-6 bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Connectors & Integrations</h2>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-700">
                  <thead className="bg-slate-50 text-slate-600 font-semibold border-b border-slate-200 uppercase tracking-wider">
                    <tr>
                      <th className="py-2 px-3">Connector Name</th>
                      <th className="py-2 px-3">Type</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {connectors.map((conn) => (
                      <tr key={conn.id} className="hover:bg-slate-50 transition-colors">
                        <td className="py-2.5 px-3 font-semibold text-slate-900">{conn.name}</td>
                        <td className="py-2.5 px-3 text-slate-600">{conn.type}</td>
                        ...
                        <td className="py-2.5 px-3 text-slate-500 whitespace-nowrap text-[11px]">{conn.lastSync}</td>
                        <td className="py-2.5 px-3 text-right">
                          <div className="flex items-center justify-end gap-1">
                            <button
                            ...
                            >
                              <RefreshCw
                                className={`w-3.5 h-3.5 ${testingConnectorId === conn.id ? 'animate-spin text-blue-600' : ''}`}
                              />
                            </button>
                            <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-6 bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Matching Rules</h2>
                  <p className="text-[11px] text-slate-500">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-700">
                  <thead className="bg-slate-50 text-slate-600 font-semibold border-b border-slate-200 uppercase tracking-wider">
                    <tr>
                      <th className="py-2 px-3">Match Attribute</th>
                      <th className="py-2 px-3 text-center w-24">Weight (%)</th>
                      <th className="py-2 px-3 text-center w-28">Use in Matching</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {matchingRules.map((rule) => (
                      <tr key={rule.id} className="hover:bg-slate-50 transition-colors">
                        <td className="py-2.5 px-3 font-semibold text-slate-900">{rule.attribute}</td>
                        <td className="py-2.5 px-3 text-center">
                          <input
                            type="number"
                            min="0"
                            ...
                            className="w-14 text-center py-1 border border-slate-200 rounded font-semibold text-xs text-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-500"
                          />
                        </td>
                        <td className="py-2.5 px-3 text-center">
                          <button
                            ...
                            className={`relative inline-flex h-4 w-8 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                              rule.useInMatching ? 'bg-blue-600' : 'bg-slate-200'
                            }`}
                          >
                            <span
                        ...
                        <td className="py-2.5 px-3 text-slate-500 text-[11px]">{rule.description}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
                <span className="text-slate-500">
                  Total Active Weight:{' '}
                  <strong className={totalActiveWeight === 100 ? 'text-emerald-600' : 'text-amber-600'}>
                    {totalActiveWeight}%
                  </strong>
                </span>
                <button
                  onClick={async () => {
                    try {
                      await api.put('/discovery/settings/matching-rules', { rules: matchingRules });
                    } catch (e) {
                      console.warn('Local matching rules save fallback');
                    }
                    showToast('Matching rules weights updated.');
                  }}
                  className="px-3 py-1 bg-blue-50 text-blue-700 hover:bg-blue-100 font-semibold rounded-lg text-xs"
                >
                  Apply Weights
                </button>
              </div>
            ...
            <div className="lg:col-span-6 bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
              <div className="border-b border-slate-100 pb-3">
                <h2 className="text-sm font-bold text-slate-900">Global Settings</h2>
                <p className="text-[11px] text-slate-500">System-wide settings for discovery and reconciliation</p>
              </div>

              <form onSubmit={handleSaveGlobalSettings} className="space-y-3.5 text-xs">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <label className="block font-semibold text-slate-800">Stale Device Threshold (days)</label>
                    <span className="text-[11px] text-slate-400">Mark device as stale if not seen in this many days</span>
                  </div>
                  <input
                    type="number"
                    min="1"
                    ...
                    className="w-16 px-2 py-1 text-center border border-slate-200 rounded-lg text-xs font-semibold"
                  />
                </div>

                <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-50">
                  <div>
                    <label className="block font-semibold text-slate-800">Auto Create Exception for Unknown Devices</label>
                    <span className="text-[11px] text-slate-400">Create an exception record for unregistered devices</span>
                  </div>
                  <button
                    type="button"
                    ...
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      globalSettings.autoCreateExceptionForUnknown ? 'bg-blue-600' : 'bg-slate-200'
                    }`}
                  >
                    <span
                ...
                <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-50">
                  <div>
                    <label className="block font-semibold text-slate-800">Enable Software Inventory</label>
                    <span className="text-[11px] text-slate-400">Collect installed software information where supported</span>
                  </div>
                  <button
                    type="button"
                    onClick={() => setGlobalSettings({ ...globalSettings, enableSoftwareInventory: !globalSettings.enableSoftwareInventory })}
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      globalSettings.enableSoftwareInventory ? 'bg-blue-600' : 'bg-slate-200'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                ...
                <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-50">
                  <div>
                    <label className="block font-semibold text-slate-800">Default Discovery Schedule</label>
                    <span className="text-[11px] text-slate-400">Default schedule for new profiles</span>
                  </div>
                  <select
                    ...
                    className="px-2.5 py-1 text-xs border border-slate-200 rounded-lg bg-white text-slate-700 font-semibold"
                  >
                ...
                <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-50">
                  <div>
                    <label className="block font-semibold text-slate-800">Notification Email</label>
                    <span className="text-[11px] text-slate-400">Send alerts for discovery failures and exceptions</span>
                  </div>
                  <input
                    type="email"
                    ...
                    className="w-48 px-2.5 py-1 text-xs border border-slate-200 rounded-lg text-slate-700"
                  />
                </div>

                <div className="flex items-center justify-between gap-3 pt-2 border-t border-slate-50">
                  <div>
                    <label className="block font-semibold text-slate-800">Enable Discovery Audit Log</label>
                    <span className="text-[11px] text-slate-400">Log all discovery activities and changes</span>
                  </div>
                  <button
                    type="button"
                    onClick={() => setGlobalSettings({ ...globalSettings, enableDiscoveryAuditLog: !globalSettings.enableDiscoveryAuditLog })}
                    className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      globalSettings.enableDiscoveryAuditLog ? 'bg-blue-600' : 'bg-slate-200'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
      ...
      {activeTab === 'classification' && (
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              <h2 className="text-sm font-bold text-slate-900">Device Classification Mapping</h2>
              <p className="text-[11px] text-slate-500">
              ...
              <tbody className="divide-y divide-slate-100">
                {classifications.map((c) => (
                  <tr key={c.id} className="hover:bg-slate-50">
                    <td className="py-2.5 px-3 font-semibold text-slate-900">{c.discoveredType}</td>
                    ...
                    <td className="py-2.5 px-3 font-medium text-blue-700">{c.category}</td>
      ...
      {activeTab === 'schedule' && (
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              <h2 className="text-sm font-bold text-slate-900">Discovery Schedules</h2>
              <p className="text-[11px] text-slate-500">
              ...
              <tbody className="divide-y divide-slate-100">
                {schedules.map((s) => (
                  <tr key={s.id} className="hover:bg-slate-50">
                    ...
                    <td className="py-2.5 px-3 text-slate-700 font-medium">{s.profileName}</td>
      ...
      {activeTab === 'credentials' && (
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              <h2 className="text-sm font-bold text-slate-900">Credential Vault (Encrypted References)</h2>
              <p className="text-[11px] text-slate-500">
      ...
      {activeTab === 'connectors' && (
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              <h2 className="text-sm font-bold text-slate-900">Third-Party IT Connectors</h2>
              <p className="text-[11px] text-slate-500">
                    ...
                    <td className="py-2.5 px-3 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <button
                          title="Test Connection"
                          onClick={() => handleTestConnector(conn.id)}
                          className="px-2 py-0.5 text-[11px] bg-slate-100 text-slate-700 hover:bg-slate-200 rounded font-medium"
                        >
                          Test
                        </button>
                        <button
                          ...
                          className="px-2 py-0.5 text-[11px] bg-blue-50 text-blue-700 hover:bg-blue-100 rounded font-medium"
                        >
                          Sync
                        </button>
                      </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-slate-900 text-base">New Discovery Profile</h3>
              </div>
              <button
            ...
            >
              ...
              <div>
                <label className="block font-semibold text-slate-700 mb-1">Discovery Type</label>
                <select name="discoveryType" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-xs bg-white">
                  <option value="IP Range Scan">IP Range Scan</option>
                  <option value="SNMP Scan">SNMP Scan</option>
                  <option value="WMI Scan">WMI Scan</option>
                  <option value="Agent Based">Agent Based</option>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Start IP</label>
                  <input
                    name="ipStart"
                    required
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">End IP</label>
                  <input
                    name="ipEnd"
                    required
                    placeholder="192.168.1.254"
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-slate-900 text-base">New Secure Credential</h3>
              </div>
              <button
            ...
            >
              <div>
                <label className="block font-semibold text-slate-700 mb-1">Credential Name *</label>
                <input
                  name="name"
                  required
              ...
              <div>
                ...
                <select name="type" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-xs bg-white">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Username / Account</label>
                  <input
                    name="username"
                    required
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Secret / Password / Key *</label>
                  <input
                    type="password"
                    name="secret"
                    required
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-slate-900 text-base">Add Third-Party Connector</h3>
              </div>
              <button
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Connector Type</label>
                  <select name="type" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-xs bg-white">
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Target System</label>
                  <input
                    name="targetSystem"
                    required
              ...
              <div>
                <label className="block font-semibold text-slate-700 mb-1">Endpoint API URL</label>
                <input
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-bold text-slate-900 text-base">Add Classification Mapping Rule</h3>
              </div>
              <button
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Discovered Type</label>
                  <select name="discoveredType" className="w-full px-2.5 py-1.5 border border-slate-200 rounded-lg bg-white">
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">OS / Model Regex</label>
                  <input
                    name="osPattern"
                    defaultValue=".*"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Target Asset Group</label>
                  <input name="assetGroup" defaultValue="IT Equipment" className="w-full px-2.5 py-1.5 border border-slate-200 rounded-lg" />
                </div>
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Target Asset Class</label>
                  <input name="assetClass" defaultValue="End User Computing" className="w-full px-2.5 py-1.5 border border-slate-200 rounded-lg" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input name="category" defaultValue="Computer" className="w-full px-2.5 py-1.5 border border-slate-200 rounded-lg" />
                </div>
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Target Subcategory</label>
                  <input name="subcategory" defaultValue="Laptop" className="w-full px-2.5 py-1.5 border border-slate-200 rounded-lg" />
                </div>
              </div>
